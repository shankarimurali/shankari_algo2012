...
//------------------------------------------------------------
void particle::draw(){
    for (int j=0; j<particleTrail.size(); j++) {
		ofSetColor(78, 75, 75,ofMap(j, 0, particleTrail.size(), 100, 120, true));
		if (j==particleTrail.size()-1) {
			ofSetColor(0, 0, 0,255);
		}
		ofCircle(particleTrail[j].x, particleTrail[j].y, ofMap(j, 0, particleTrail.size(), 0.1, 1.5, true));
